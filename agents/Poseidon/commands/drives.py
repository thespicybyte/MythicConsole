...
drives_parser = Cmd2ArgumentParser(description="Get information about mounted drives on Linux hosts only")
...
class Drives(AgentCommand):
    def __init__(self, agent: MythicAgent):
        ...
        self._name = "drives"
        self._description = "Get information about mounted drives on Linux hosts only"
